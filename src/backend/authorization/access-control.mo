...
module {
  ...
  // Returns true if caller is a non-anonymous, registered principal.
  public func isRegistered(state : AccessControlState, caller : Principal) : Bool {
  ...
  // Auto-registers caller as a user if not already registered.
